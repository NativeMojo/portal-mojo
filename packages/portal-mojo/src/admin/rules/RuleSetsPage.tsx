...
export function RuleSetsPage() {
    ...
    const filters: FilterDef[] = [{ key: 'is_active', label: 'Active', type: 'boolean' }, { key: 'category', label: 'Category', type: 'text' }, { key: 'priority', label: 'Priority', type: 'number' }, { key: 'bundle_by', label: 'Bundle mode', type: 'select', options: [...BUNDLE_BY_OPTIONS] }];
