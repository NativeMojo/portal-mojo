...
export async function openHandlerChainEditor(row: RuleSetRow): Promise<boolean> { return (await modal.open<boolean>((close) => <HandlerEditor row={row} close={close} />, { size: 'xl' })) ?? false; }
